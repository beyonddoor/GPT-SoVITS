...
rsync_code() {
    rsync -av --include='*/' --include='*.py' --include='*.md' --include='*.sh' --exclude='*' --prune-empty-dirs ./ "${1:-none}":GPT-SoVITS/
    # rsync -avc --ignore-times ./ "${1:-none}":GPT-SoVITS/ --include '**/' --include '**/*.py' --exclude '*' --prune-empty-dirs 
    # rsync -avc --ignore-times ./ "${1:-none}":GPT-SoVITS/ --include '**/' --include '**/*.sh' --exclude '*' --prune-empty-dirs 
    # rsync -avc --ignore-times ./ "${1:-none}":GPT-SoVITS/ --include '**/' --include '**/*.md' --exclude '*' --prune-empty-dirs 
